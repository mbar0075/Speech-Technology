...
image = cv2.imread(os.path.join("/Users/andrea/UM/Work/ILLT/2022:23/LIN3503:ARI3210 - Speech Technology/Week 6 - Convolutional Neural Networks (11th November)",
                   args["image"]))
...
# python convolutions.py --image specgtrogram.png